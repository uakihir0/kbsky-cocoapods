...
@class KbskyBskyFactoryCompanion, KbskyCoreATProtocolFactory, KbskyStreamATProtocolStreamFactory, KbskyCoreATProtocolTypes, KbskyCoreBlueskyTypes, KbskyCoreBlueskyFactory, KbskyCorePLCDirectoryFactory, KbskyCoreDIDDetails, KbskyCoreResponse<T>, KbskyCoreDIDLog, KbskyCoreIdentityResolveHandleResponse, KbskyCoreIdentityResolveHandleRequest, KbskyCoreRepoCreateRecordResponse, KbskyCoreRepoCreateRecordRequest, KbskyKotlinUnit, KbskyCoreRepoDeleteRecordRequest, KbskyCoreRepoGetRecordResponse, KbskyCoreRepoGetRecordRequest, KbskyCoreRepoListRecordsResponse, KbskyCoreRepoListRecordsRequest, KbskyCoreRepoUploadBlobResponse, KbskyCoreRepoUploadBlobRequest, KbskyCoreServerCreateSessionResponse, KbskyCoreServerCreateSessionRequest, KbskyCoreAuthRequest, KbskyCoreServerGetSessionResponse, KbskyCoreServerRefreshSessionResponse, KbskyCoreActorGetPreferencesResponse, KbskyCoreActorGetPreferencesRequest, KbskyCoreActorGetProfileResponse, KbskyCoreActorGetProfileRequest, KbskyCoreActorGetProfilesResponse, KbskyCoreActorGetProfilesRequest, KbskyCoreActorSearchActorsResponse, KbskyCoreActorSearchActorsRequest, KbskyCoreFeedDeleteLikeRequest, KbskyCoreFeedDeletePostRequest, KbskyCoreFeedDeleteRepostRequest, KbskyCoreFeedGetActorFeedsResponse, KbskyCoreFeedGetActorFeedsRequest, KbskyCoreFeedGetActorLikesResponse, KbskyCoreFeedGetActorLikesRequest, KbskyCoreFeedGetAuthorFeedResponse, KbskyCoreFeedGetAuthorFeedRequest, KbskyCoreFeedGetFeedResponse, KbskyCoreFeedGetFeedRequest, KbskyCoreFeedGetFeedGeneratorResponse, KbskyCoreFeedGetFeedGeneratorRequest, KbskyCoreFeedGetFeedGeneratorsResponse, KbskyCoreFeedGetFeedGeneratorsRequest, KbskyCoreFeedGetLikesResponse, KbskyCoreFeedGetLikesRequest, KbskyCoreFeedGetPostThreadResponse, KbskyCoreFeedGetPostThreadRequest, KbskyCoreFeedGetPostsResponse, KbskyCoreFeedGetPostsRequest, KbskyCoreFeedGetRepostedByResponse, KbskyCoreFeedGetRepostedByRequest, KbskyCoreFeedGetTimelineResponse, KbskyCoreFeedGetTimelineRequest, KbskyCoreFeedLikeResponse, KbskyCoreFeedLikeRequest, KbskyCoreFeedPostResponse, KbskyCoreFeedPostRequest, KbskyCoreFeedRepostResponse, KbskyCoreFeedRepostRequest, KbskyCoreFeedSearchPostsResponse, KbskyCoreFeedSearchPostsRequest, KbskyCoreGraphBlockResponse, KbskyCoreGraphBlockRequest, KbskyCoreGraphDeleteBlockRequest, KbskyCoreGraphDeleteFollowRequest, KbskyCoreGraphFollowResponse, KbskyCoreGraphFollowRequest, KbskyCoreGraphGetBlocksResponse, KbskyCoreGraphGetBlocksRequest, KbskyCoreGraphGetFollowersResponse, KbskyCoreGraphGetFollowersRequest, KbskyCoreGraphGetFollowsResponse, KbskyCoreGraphGetFollowsRequest, KbskyCoreGraphGetMutesResponse, KbskyCoreGraphGetMutesRequest, KbskyCoreGraphMuteActorRequest, KbskyCoreGraphUnmuteActorRequest, KbskyCoreNotificationGetUnreadCountResponse, KbskyCoreNotificationGetUnreadCountRequest, KbskyCoreNotificationListNotificationsResponse, KbskyCoreNotificationListNotificationsRequest, KbskyCoreNotificationUpdateSeenRequest, KbskyCoreUnspeccedGetPopularResponse, KbskyCoreUnspeccedGetPopularRequest, KbskyCoreDidDocUnionCompanion, KbskyCoreDidDocUnion, KbskyCoreDIDDetailsCompanion, KbskyCoreDIDDetailsService, KbskyCoreDIDDetailsVerificationMethod, KbskyCoreDIDLogCompanion, KbskyCoreDIDLogService, KbskyCoreDIDLogVerificationMethods, KbskyStreamStreamClient, KbskyStreamSyncSubscribeReposRequest, KbskyCoreIdentityResolveHandleResponseCompanion, KbskyCoreRepoCreateRecordResponseCompanion, KbskyCoreRecordUnion, KbskyCoreRepoGetRecordResponseCompanion, KbskyCoreRepoListRecordsResponseCompanion, KbskyCoreRepoListRecordsRecord, KbskyCoreRepoUploadBlobResponseCompanion, KbskyCoreBlob, KbskyKotlinByteArray, KbskyCoreServerCreateSessionResponseCompanion, KbskyCoreServerGetSessionResponseCompanion, KbskyCoreServerRefreshSessionResponseCompanion, KbskyCoreActorGetPreferencesResponseCompanion, KbskyCoreActorDefsPreferencesUnion, KbskyCoreActorDefsProfileViewDetailedCompanion, KbskyCoreLabelDefsLabel, KbskyCoreActorDefsViewerState, KbskyCoreActorDefsProfileViewDetailed, KbskyCoreActorGetProfileResponseCompanion, KbskyCoreActorGetProfilesResponseCompanion, KbskyCoreActorSearchActorsResponseCompanion, KbskyCoreActorDefsProfileView, KbskyCoreFeedGetActorFeedsResponseCompanion, KbskyCoreFeedDefsGeneratorView, KbskyCoreFeedGetActorLikesResponseCompanion, KbskyCoreFeedDefsFeedViewPost, KbskyCoreFeedGetAuthorFeedResponseCompanion, KbskyCoreFeedGetFeedResponseCompanion, KbskyCoreFeedGetFeedGeneratorResponseCompanion, KbskyCoreFeedGetFeedGeneratorsResponseCompanion, KbskyCoreFeedGetLikesResponseCompanion, KbskyCoreFeedGetLikesLike, KbskyCoreFeedGetPostThreadResponseCompanion, KbskyCoreFeedDefsThreadUnion, KbskyCoreFeedGetPostsResponseCompanion, KbskyCoreFeedDefsPostView, KbskyCoreFeedGetRepostedByResponseCompanion, KbskyCoreFeedGetTimelineResponseCompanion, KbskyCoreFeedLikeResponseCompanion, KbskyCoreFeedLike, KbskyCoreRepoStrongRef, KbskyCoreFeedPostResponseCompanion, KbskyCoreFeedPost, KbskyCoreEmbedUnion, KbskyCoreRichtextFacet, KbskyCoreFeedPostReplyRef, KbskyCoreFeedRepostResponseCompanion, KbskyCoreFeedRepost, KbskyCoreFeedSearchPostsResponseCompanion, KbskyCoreGraphBlockResponseCompanion, KbskyCoreGraphBlock, KbskyCoreGraphFollowResponseCompanion, KbskyCoreGraphFollow, KbskyCoreGraphGetBlocksResponseCompanion, KbskyCoreGraphGetFollowersResponseCompanion, KbskyCoreGraphGetFollowsResponseCompanion, KbskyCoreGraphGetMutesResponseCompanion, KbskyCoreNotificationGetUnreadCountResponseCompanion, KbskyCoreNotificationListNotificationsResponseCompanion, KbskyCoreNotificationListNotificationsNotification, KbskyCoreUnspeccedGetPopularResponseCompanion, KbskyCoreDIDDetailsServiceCompanion, KbskyCoreDIDDetailsVerificationMethodCompanion, KbskyCoreDIDLogServiceCompanion, KbskyCoreDIDLogPDS, KbskyCoreDIDLogVerificationMethodsCompanion, KbskyKhttpclientWebsocketRequest, KbskyCoreRecordUnionCompanion, KbskyCoreActorProfile, KbskyCoreRepoListRecordsRecordCompanion, KbskyCoreBlobCompanion, KbskyCoreBlobRef, KbskyKotlinByteIterator, KbskyCoreActorDefsPreferencesUnionCompanion, KbskyCoreActorDefsAdultContentPref, KbskyCoreActorDefsContentLabelPref, KbskyCoreActorDefsFeedViewPref, KbskyCoreActorDefsPersonalDetailsPref, KbskyCoreActorDefsSavedFeedsPref, KbskyCoreActorDefsThreadViewPref, KbskyCoreLabelDefsLabelCompanion, KbskyCoreActorDefsViewerStateCompanion, KbskyCoreActorDefsProfileViewCompanion, KbskyCoreEmbedRecordViewUnionCompanion, KbskyCoreEmbedRecordViewBlocked, KbskyCoreEmbedRecordViewNotFound, KbskyCoreEmbedRecordViewRecord, KbskyCoreEmbedRecordViewUnion, KbskyCoreFeedDefsGeneratorViewCompanion, KbskyCoreFeedDefsGeneratorViewerState, KbskyCoreFeedDefsFeedViewPostCompanion, KbskyCoreFeedDefsReasonRepost, KbskyCoreFeedDefsReplyRef, KbskyCoreFeedGetLikesLikeCompanion, KbskyCoreFeedDefsThreadUnionCompanion, KbskyCoreFeedDefsNotFoundPost, KbskyCoreFeedDefsThreadViewPost, KbskyCoreFeedDefsPostViewCompanion, KbskyCoreActorDefsProfileViewBasic, KbskyCoreEmbedViewUnion, KbskyCoreFeedDefsViewerState, KbskyCoreFeedLikeCompanion, KbskyCoreRepoStrongRefCompanion, KbskyCoreFeedPostCompanion, KbskyCoreEmbedUnionCompanion, KbskyCoreEmbedExternal, KbskyCoreEmbedImages, KbskyCoreEmbedRecord, KbskyCoreEmbedRecordWithMedia, KbskyCoreRichtextFacetCompanion, KbskyCoreRichtextFacetFeatureUnion, KbskyCoreRichtextFacetByteSlice, KbskyCoreFeedPostReplyRefCompanion, KbskyCoreFeedRepostCompanion, KbskyCoreGraphBlockCompanion, KbskyCoreGraphFollowCompanion, KbskyCoreNotificationListNotificationsNotificationCompanion, KbskyCoreDIDLogPDSCompanion, KbskyKotlinThrowable, KbskyKotlinArray<T>, KbskyKotlinException, KbskyKotlinRuntimeException, KbskyKotlinIllegalStateException, KbskyKtor_httpHttpMethod, KbskyCoreActorProfileCompanion, KbskyCoreBlobRefCompanion, KbskyCoreActorDefsAdultContentPrefCompanion, KbskyCoreActorDefsContentLabelPrefCompanion, KbskyCoreActorDefsFeedViewPrefCompanion, KbskyCoreActorDefsPersonalDetailsPrefCompanion, KbskyCoreActorDefsSavedFeedsPrefCompanion, KbskyCoreActorDefsThreadViewPrefCompanion, KbskyCoreEmbedRecordViewBlockedCompanion, KbskyCoreEmbedRecordViewNotFoundCompanion, KbskyCoreEmbedRecordViewRecordCompanion, KbskyCoreFeedDefsGeneratorViewerStateCompanion, KbskyCoreFeedDefsReasonRepostCompanion, KbskyCoreFeedDefsReplyRefCompanion, KbskyCoreFeedDefsNotFoundPostCompanion, KbskyCoreFeedDefsThreadViewPostCompanion, KbskyCoreActorDefsProfileViewBasicCompanion, KbskyCoreEmbedViewUnionCompanion, KbskyCoreEmbedExternalView, KbskyCoreEmbedImagesView, KbskyCoreEmbedRecordView, KbskyCoreEmbedRecordWithMediaView, KbskyCoreFeedDefsViewerStateCompanion, KbskyCoreEmbedExternalCompanion, KbskyCoreEmbedExternalExternal, KbskyCoreEmbedImagesCompanion, KbskyCoreEmbedImagesImage, KbskyCoreEmbedRecordCompanion, KbskyCoreEmbedRecordWithMediaCompanion, KbskyCoreRichtextFacetFeatureUnionCompanion, KbskyCoreRichtextFacetLink, KbskyCoreRichtextFacetMention, KbskyCoreRichtextFacetTag, KbskyCoreRichtextFacetByteSliceCompanion, KbskyKotlinx_serialization_coreSerializersModule, KbskyKotlinx_serialization_coreSerialKind, KbskyKotlinNothing, KbskyKtor_httpHttpMethodCompanion, KbskyCoreEmbedExternalViewCompanion, KbskyCoreEmbedExternalViewExternal, KbskyCoreEmbedImagesViewCompanion, KbskyCoreEmbedImagesViewImage, KbskyCoreEmbedRecordViewCompanion, KbskyCoreEmbedRecordWithMediaViewCompanion, KbskyCoreEmbedExternalExternalCompanion, KbskyCoreEmbedImagesImageCompanion, KbskyCoreRichtextFacetLinkCompanion, KbskyCoreRichtextFacetMentionCompanion, KbskyCoreRichtextFacetTagCompanion, KbskyCoreEmbedExternalViewExternalCompanion, KbskyCoreEmbedImagesViewImageCompanion;

@protocol KbskyCoreATProtocol, KbskyCoreBluesky, KbskyCorePLCDirectory, KbskyStreamATProtocolStream, KbskyCoreIdentityResource, KbskyCoreRepoResource, KbskyCoreServerResource, KbskyCoreActorResource, KbskyCoreFeedResource, KbskyCoreGraphResource, KbskyCoreNotificationResource, KbskyCoreUnspeccedResource, KbskyStreamSyncResource, KbskyCoreMapRequest, KbskyCoreRKeyRequest, KbskyCoreRecordRequest, KbskyKotlinx_serialization_coreKSerializer, KbskyStreamClosedCallback, KbskyStreamErrorCallback, KbskyStreamEventCallback, KbskyStreamOpenedCallback, KbskyKotlinx_serialization_coreEncoder, KbskyKotlinx_serialization_coreSerialDescriptor, KbskyKotlinx_serialization_coreSerializationStrategy, KbskyKotlinx_serialization_coreDecoder, KbskyKotlinx_serialization_coreDeserializationStrategy, KbskyKotlinSuspendFunction1, KbskyKotlinIterator, KbskyKotlinx_serialization_coreCompositeEncoder, KbskyKotlinAnnotation, KbskyKotlinx_serialization_coreCompositeDecoder, KbskyKotlinFunction, KbskyKotlinx_serialization_coreSerializersModuleCollector, KbskyKotlinKClass, KbskyKotlinKDeclarationContainer, KbskyKotlinKAnnotatedElement, KbskyKotlinKClassifier;
...
- (id<KbskyStreamATProtocolStream>)instanceApiUri:(NSString *)apiUri streamUri:(NSString *)streamUri __attribute__((swift_name("instance(apiUri:streamUri:)")));
@end
...
- (void)describeRepo __attribute__((swift_name("describeRepo()")));
...
- (void)putRecord __attribute__((swift_name("putRecord()")));
...
- (KbskyCoreDIDDetails * _Nullable)DIDDetails __attribute__((swift_name("DIDDetails()")));
@end
...
- (instancetype)initWithAccessJwt:(NSString *)accessJwt bytes:(KbskyKotlinByteArray *)bytes name:(NSString *)name __attribute__((swift_name("init(accessJwt:bytes:name:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithAccessJwt:(NSString *)accessJwt __attribute__((swift_name("init(accessJwt:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
...
@required
- (NSString *)createdAt __attribute__((swift_name("createdAt()")));
@property (getter=createdAt_) NSString * _Nullable createdAt __attribute__((swift_name("createdAt")));
@end
...
- (KbskyCoreActorProfile * _Nullable)actorProfile __attribute__((swift_name("actorProfile()")));
- (KbskyCoreFeedLike * _Nullable)feedLike __attribute__((swift_name("feedLike()")));
- (KbskyCoreFeedPost * _Nullable)feedPost __attribute__((swift_name("feedPost()")));
- (KbskyCoreFeedRepost * _Nullable)feedRepost __attribute__((swift_name("feedRepost()")));
- (KbskyCoreGraphBlock * _Nullable)graphBlock __attribute__((swift_name("graphBlock()")));
- (KbskyCoreGraphFollow * _Nullable)graphFollow __attribute__((swift_name("graphFollow()")));
...
- (KbskyCoreActorDefsAdultContentPref * _Nullable)adultContentPref __attribute__((swift_name("adultContentPref()")));
- (KbskyCoreActorDefsContentLabelPref * _Nullable)contentLabelPref __attribute__((swift_name("contentLabelPref()")));
- (KbskyCoreActorDefsFeedViewPref * _Nullable)feedViewPref __attribute__((swift_name("feedViewPref()")));
- (KbskyCoreActorDefsPersonalDetailsPref * _Nullable)personalDetailsPref __attribute__((swift_name("personalDetailsPref()")));
- (KbskyCoreActorDefsSavedFeedsPref * _Nullable)savedFeedsPref __attribute__((swift_name("savedFeedsPref()")));
- (KbskyCoreActorDefsThreadViewPref * _Nullable)threadViewPref __attribute__((swift_name("threadViewPref()")));
...
- (KbskyCoreEmbedRecordViewBlocked * _Nullable)blocked __attribute__((swift_name("blocked()")));
- (KbskyCoreFeedDefsGeneratorView * _Nullable)generatorView __attribute__((swift_name("generatorView()")));
- (KbskyCoreEmbedRecordViewNotFound * _Nullable)notFound __attribute__((swift_name("notFound()")));
- (KbskyCoreEmbedRecordViewRecord * _Nullable)record __attribute__((swift_name("record()")));
...
@property KbskyCoreFeedDefsReasonRepost * _Nullable reason __attribute__((swift_name("reason")));
...
- (KbskyCoreFeedDefsNotFoundPost * _Nullable)notFoundPost __attribute__((swift_name("notFoundPost()")));
- (KbskyCoreFeedDefsThreadViewPost * _Nullable)viewPost __attribute__((swift_name("viewPost()")));
...
@property KbskyCoreActorDefsProfileViewBasic * _Nullable author __attribute__((swift_name("author")));
@property NSString * _Nullable cid __attribute__((swift_name("cid")));
...
- (KbskyCoreEmbedExternal * _Nullable)external __attribute__((swift_name("external()")));
- (KbskyCoreEmbedImages * _Nullable)images __attribute__((swift_name("images()")));
- (KbskyCoreEmbedRecord * _Nullable)record __attribute__((swift_name("record()")));
- (KbskyCoreEmbedRecordWithMedia * _Nullable)recordWithMedia __attribute__((swift_name("recordWithMedia()")));
...
- (void)sendBinaryContent:(KbskyKotlinByteArray *)content __attribute__((swift_name("sendBinary(content:)")));
- (void)sendTextText:(NSString *)text __attribute__((swift_name("sendText(text:)")));
...
@interface KbskyCoreFeedDefsReasonRepost : KbskyBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
@property KbskyCoreActorDefsProfileViewBasic * _Nullable by __attribute__((swift_name("by")));
@property NSString * _Nullable indexedAt __attribute__((swift_name("indexedAt")));
@end
...
- (KbskyCoreEmbedExternalView * _Nullable)external __attribute__((swift_name("external()")));
- (KbskyCoreEmbedImagesView * _Nullable)images __attribute__((swift_name("images()")));
- (KbskyCoreEmbedRecordView * _Nullable)record __attribute__((swift_name("record()")));
- (KbskyCoreEmbedRecordWithMediaView * _Nullable)recordWithMedia __attribute__((swift_name("recordWithMedia()")));
...
@property (getter=external_) KbskyCoreEmbedExternalExternal * _Nullable external __attribute__((swift_name("external")));
...
@property (getter=images_) NSArray<KbskyCoreEmbedImagesImage *> * _Nullable images __attribute__((swift_name("images")));
...
@property (getter=record_) KbskyCoreRepoStrongRef * _Nullable record __attribute__((swift_name("record")));
...
@property (getter=record_) KbskyCoreEmbedRecord * _Nullable record __attribute__((swift_name("record")));
...
- (KbskyCoreRichtextFacetLink * _Nullable)link __attribute__((swift_name("link()")));
- (KbskyCoreRichtextFacetMention * _Nullable)mention __attribute__((swift_name("mention()")));
- (KbskyCoreRichtextFacetTag * _Nullable)tag __attribute__((swift_name("tag()")));
...
@property (getter=external_) KbskyCoreEmbedExternalViewExternal * _Nullable external __attribute__((swift_name("external")));
...
@property (getter=images_) NSArray<KbskyCoreEmbedImagesViewImage *> * _Nullable images __attribute__((swift_name("images")));
...
@property (getter=record_) KbskyCoreEmbedRecordViewUnion * _Nullable record __attribute__((swift_name("record")));
...
@property (getter=record_) KbskyCoreEmbedRecordView * _Nullable record __attribute__((swift_name("record")));
...
@property (getter=tag_) NSString *tag __attribute__((swift_name("tag")));
