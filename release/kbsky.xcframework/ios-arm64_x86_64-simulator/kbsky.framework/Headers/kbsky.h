...
- (instancetype)initWithAccessJwt:(NSString *)accessJwt displayName:(NSString * _Nullable)displayName description:(NSString * _Nullable)description avatar:(KbskyCoreBlob * _Nullable)avatar banner:(KbskyCoreBlob * _Nullable)banner clearBanner:(BOOL)clearBanner __attribute__((swift_name("init(accessJwt:displayName:description:avatar:banner:clearBanner:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithAccessJwt:(NSString *)accessJwt __attribute__((swift_name("init(accessJwt:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
